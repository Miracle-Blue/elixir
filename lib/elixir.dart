...
typedef ElixirNavigationState = List<Page<Object?>>;
...
class Elixir extends StatefulWidget {
  ...
  /// that encloses the given context, if any.
  static ElixirNavigationState? stateOf(BuildContext context) => maybeOf(context)?.state;
  ...
  /// Change the pages.
  static void change(BuildContext context, ElixirNavigationState Function(ElixirNavigationState pages) fn) =>
